...
import { createNewBlogCategory } from "../../firebase/services/firestoreServices";

import { nameError } from "../../constants/errors";

export default function CreateNewBlogCategory() {
  ...
  useEffect(() => {
    document.title = "Create Blog Category";
  }, []);
  ...
  return (
    <Container className={styles.backgroundContainer}>
      <h1 className={styles.primaryHeading}>Create a new Blog Category</h1>

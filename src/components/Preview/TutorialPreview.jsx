...
export default function TutorialPreview({ data }) {
    ...
    <Fragment>
      <Navigation
        pageHierarchyList={[
          ...
          {
            link: `/tutorials/${data.tutorialCategorySlug}`,
            title: data.tutorialCategoryTitle,
          },
          {
            link: `/tutorials/${data.tutorialCategorySlug}/${data.tutorialSubcategorySlug}`,
            title: data.tutorialSubcategoryTitle,
          },
          {
            link: `/tutorials/${data.tutorialCategorySlug}/${data.tutorialSubcategorySlug}/${data.tutorialSeriesSlug}`,
            title: data.tutorialSeriesTitle,
          },
          {
            link: `/tutorials/${data.blogCategorySlug}/${data.blogSubcategorySlug}/${data.tutorialSeriesSlug}/${data.slug}`,
            title: data.title,
          },
        ]}
      />

...
import { createNewTutorialSubcategory } from "../../firebase/services/Firestore Services/tutorialSubcategories";

import { nameError } from "../../constants/errors";

export default function CreateNewTutorialSubcategory() {
  ...
  useEffect(() => {
    document.title = "Create Tutorial Subcategory";
  ...
  const create = async () => {
    ...
    await createNewTutorialSubcategory(newDocumentObject, {
  ...
  return (
    <Container className={styles.backgroundContainer}>
      <h1 className={styles.primaryHeading}>Create a new Tutorial Subcategory</h1>
      ...
      {isUploading ? (
        ...
        <Button
          ...
          onClick={create}
        >
          Create New Tutorial Subcategory
        </Button>
      )}
      <br />
      <br />
